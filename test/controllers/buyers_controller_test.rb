...
class BuyersControllerTest < ActionController::TestCase
  ...
  test "should create buyer" do
    assert_difference('Buyer.count') do
      post :create, buyer: { address: @buyer.address, contact: @buyer.contact, email: @buyer.email, name: @buyer.name }
    end
  ...
  test "should update buyer" do
    patch :update, id: @buyer, buyer: { address: @buyer.address, contact: @buyer.contact, email: @buyer.email, name: @buyer.name }
    assert_redirected_to buyer_path(assigns(:buyer))
  end
